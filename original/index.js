...
// include: /var/folders/16/cp7p7gb90wd8805117nt9jt80000gn/T/tmp6vtk0flh.js
...
// end include: /var/folders/16/cp7p7gb90wd8805117nt9jt80000gn/T/tmp6vtk0flh.js
// include: /var/folders/16/cp7p7gb90wd8805117nt9jt80000gn/T/tmpvgx_z5r1.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/16/cp7p7gb90wd8805117nt9jt80000gn/T/tmpvgx_z5r1.js
// include: /var/folders/16/cp7p7gb90wd8805117nt9jt80000gn/T/tmpwgbjva7i.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/16/cp7p7gb90wd8805117nt9jt80000gn/T/tmpwgbjva7i.js
...
var ASM_CONSTS = {
  120544: () => { if (document.fullscreenElement) return 1; },  
 120590: () => { return document.getElementById('canvas').width; },  
 120642: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120710: () => { document.exitFullscreen(); },  
 120737: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 120810: () => { if (document.fullscreenElement) return 1; },  
 120856: () => { return document.getElementById('canvas').width; },  
 120908: () => { return screen.width; },  
 120933: () => { document.exitFullscreen(); },  
 120960: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 121093: () => { return window.innerWidth; },  
 121119: () => { return window.innerHeight; },  
 121146: () => { if (document.fullscreenElement) return 1; },  
 121192: () => { return document.getElementById('canvas').width; },  
 121244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121312: () => { if (document.fullscreenElement) return 1; },  
 121358: () => { return document.getElementById('canvas').width; },  
 121410: () => { return screen.width; },  
 121435: () => { return window.innerWidth; },  
 121461: () => { return window.innerHeight; },  
 121488: () => { if (document.fullscreenElement) return 1; },  
 121534: () => { return document.getElementById('canvas').width; },  
 121586: () => { return screen.width; },  
 121611: () => { document.exitFullscreen(); },  
 121638: () => { if (document.fullscreenElement) return 1; },  
 121684: () => { return document.getElementById('canvas').width; },  
 121736: () => { return parseInt(document.getElementById('canvas').style.width); },  
 121804: () => { document.exitFullscreen(); },  
 121831: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 121889: () => { return screen.width; },  
 121914: () => { return screen.height; },  
 121940: () => { return window.screenX; },  
 121967: () => { return window.screenY; },  
 121994: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 122047: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 122118: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 122175: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 122431: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 122502: () => { if (document.fullscreenElement) return 1; },  
 122548: () => { return window.innerWidth; },  
 122574: () => { return window.innerHeight; },  
 122601: () => { if (document.pointerLockElement) return 1; }
};
